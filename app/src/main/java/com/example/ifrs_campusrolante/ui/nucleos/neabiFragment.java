...
public class neabiFragment extends Fragment {
    ...
    public neabiFragment() {
        // Construtor vazio obrigatório
    }

    public static neabiFragment newInstance() {
        return new neabiFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_neabi, container, false);
