...
public class indissociaveisFragment extends Fragment {
    ...
    public static indissociaveisFragment newInstance() {
        return new indissociaveisFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_indissociaveis, container, false);
