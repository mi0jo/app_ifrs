...
public class feirasFragment extends Fragment {
    ...
    public feirasFragment() {
        // Construtor vazio obrigatório
    }

    public static feirasFragment newInstance() {
        return new feirasFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_feiras, container, false);
        ...
        List<Integer> imagens = Arrays.asList(
                R.drawable.mostratec,
                R.drawable.salaobento,
                R.drawable.moscling,
                R.drawable.seurs
