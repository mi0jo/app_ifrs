...
public class nepgsFragment extends Fragment {
    ...
    public nepgsFragment() {
        // Construtor vazio obrigatório
    }

    public static nepgsFragment newInstance() {
        return new nepgsFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_nepgs, container, false);
        ...
        List<Integer> imagens = Arrays.asList(
                R.drawable.eventonepgs,
                R.drawable.nepgsdiversidade,
                R.drawable.nepgsinfo,
                R.drawable.nepgspalestra
